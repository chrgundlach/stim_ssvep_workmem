...
for i_con = 1:numel(summ.hits)
    fprintf(1,...
        ...
        t.textin{i_con}, summ.hits(i_con)/sum([responses.condition]==i_con)*100, summ.hits(i_con), summ.misses(i_con), ...
...
text2present=                   [...                % text for feedback
    ...
    sprintf('\n\n\nMisses = %1.0f; error = %1.0f',summ.misses(1), summ.CR(1))...
    sprintf('\n\nerror = %1.0f; FA = %1.0f',summ.FA_proper(1), summ.FA(1)	)...
    ];
